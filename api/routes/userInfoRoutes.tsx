...
router.post("/upload_external", upload_external.single('file'), UserInfoController.upload);
router.post("/upload_internal", upload_internal.single('file'), UserInfoController.upload);
